...
See section TODO on how the mutation rate and fitness delta are used.

#### `ChAParams`

The parameters relating to the structure of chromosomal aberrations. The parameters are:
