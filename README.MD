...
* `IsFemale: bool` Wether the Genome should include two X chromosomes (true) or one X and one Y chromosome (false).
* `Assembly: hg19 or hg38` Which assembly for gene locations the program should use.
