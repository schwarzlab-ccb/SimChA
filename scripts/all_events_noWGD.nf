...
params.simcha_params_file = "/projects/ag-schwarzr/project-simcha/simcha/configs/all_events_noWGD.json"

process SimChA {
	publishDir "${workflow.launchDir}/results_all_events_noWGD/${ess}", mode: 'move'
