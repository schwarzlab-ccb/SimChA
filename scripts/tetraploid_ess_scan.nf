...
params.simcha_params_file = "/projects/ag-schwarzr/project-simcha/simcha/configs/tetraploid_essentiality_scan.json"

process SimChA {
	publishDir "${workflow.launchDir}/results_tetraploid_ess_scan/${ess}", mode: 'move'
