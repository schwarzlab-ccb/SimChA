...
python3 scripts/fish.py out/populations.csv out/parent_tree.csv out/fish.png -S 42 --smooth 50
python3 scripts/fish.py out/populations.csv out/parent_tree.csv out/fish_abs.png -S 42 --absolute --smooth 50
