...
python3 scripts/fish.py out/populations.csv out/parent_tree.csv out/fish.png -R 42 -S 1
python3 scripts/fish.py out/populations.csv out/parent_tree.csv out/fish_abs.png -R 42 -S 1 -a  
